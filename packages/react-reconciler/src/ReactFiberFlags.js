...
export const Placement = /*                    */ 0b0000000000000000000010; // 插入到页面中
export const Update = /*                       */ 0b0000000000000000000100; // 更新
export const PlacementAndUpdate = /*           */ Placement | Update;       // 插入到页面中并更新
export const Deletion = /*                     */ 0b0000000000000000001000; // 删除
